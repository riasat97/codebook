                ...
                <ul class="shortcut-list">
                    <li>
                        <a href="javascript:void(0);">
                            <img src="<?php echo base_url(); ?>img/icons/packs/crystal/48x48/apps/kedit.png">
                            Write an Article
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="<?php echo base_url(); ?>img/icons/packs/crystal/48x48/apps/penguin.png">
                            User Manager
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="<?php echo base_url(); ?>img/icons/packs/crystal/48x48/apps/wifi.png">
                            Control Monitor
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="<?php echo base_url(); ?>img/icons/packs/crystal/48x48/apps/mailreminder.png">
                            Check the Mails
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="<?php echo base_url(); ?>img/icons/packs/crystal/48x48/apps/Volume Manager.png">
                            Statistics
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="<?php echo base_url(); ?>img/icons/packs/crystal/48x48/apps/terminal.png">
                            Manage Console
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="<?php echo base_url(); ?>img/icons/packs/crystal/48x48/apps/knotes.png">
                            Notes
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);">
                            <img src="<?php echo base_url(); ?>img/icons/packs/crystal/48x48/apps/kview.png">
                            Manage Images
                        </a>
                    </li>
                </ul>
