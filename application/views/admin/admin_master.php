    ...
    <aside id="sidebar">
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		...
	    		<li><a href="<?php echo base_url();?>super_admin/add_category"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/application-form.png">Add Category</a></li>
	    		<li><a href="<?php echo base_url();?>super_admin/view_category"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/table.png">Manage Category</a></li>
	    		<li><a href="<?php echo base_url();?>super_admin/post_blog"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/chart.png">Post Blog</a></li>
                        <li><a href="<?php echo base_url();?>super_admin/manage_blog"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/chart.png"> Blog Manager </a></li>
                        <li><a href="<?php echo base_url();?>super_admin/manage_comments"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/chart.png"> Comments Manager </a></li>
                <!--        <li>
