...
<head>
  ...
  <script src="<?php echo base_url();?><?php echo base_url();?>js/libs/modernizr-2.0.6.min.js"></script>
</head>
    ...
    <section id="login-box">
    	...
    	<div class="block-border">
    		<div class="block-header">
                        <h1>Login</h1>
                        <span style="display: inline; color: red; font-size: 12px; width: 300px;">
                                <?php
    		...
    		<form id="login-form" class="block-content form" action="<?php echo base_url()?>blogger_login/blogger_login_check" method="post">
    			<p class="inline-small-label">
					<label for="username">Email</label>
					<input type="text" name="user_email_address" value="" class="required">
				</p>
				<p class="inline-small-label">
