...
<body id="top">
  ...
  <div id="container">
    ...
    <div id="header-surround"><header id="header">
		...
		<div id="user-info">
			<p>
				<span class="messages">Hello <a href="javascript:void(0);"><?php echo $this->session->userdata('user_name');?></a> ( <a href="javascript:void(0);"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/mail.png" alt="Messages"> 3 new messages</a> )</span>
				<a href="javascript:void(0)" class="toolbox-action button">Settings</a> <a href="<?php echo base_url();?>super_user/logout" class="button red">Logout</a>
			</p>
    ...
    <aside id="sidebar">
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		<li><a href="<?php echo base_url();?>super_user/view_blogger_profile"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/chart.png">Profile</a></li>
                        <li>
	    			<a href="javascript:void(0);"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/clipboard-list.png">Posts</a>
	    			<ul class="sub">
	    				<li><a href="<?php echo base_url();?>super_user/view_blog">Your posts</a></li>
	    				<li><a href="<?php echo base_url();?>super_user/post_blog">Add new post</a></li>
	    			</ul>
	    		</li>
                        <li>
	    			<a href="javascript:void(0);"><img src="<?php echo base_url();?>img/icons/packs/fugue/16x16/clipboard-list.png">Comments</a>
	    			<ul class="sub">
	    				<li><a href="<?php echo base_url();?>super_user/view_all_comments">All Comments</a></li>
	    				<li><a href="<?php echo base_url();?>super_user/view_specific_comments">Your Comments</a></li>
	    			</ul>
	    		</li>
