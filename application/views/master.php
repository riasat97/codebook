...
<div id="header" class="container">
	<div id="logo">
		<h1><a href="<?php echo base_url();?>home/index.jsp">CodeBook</a></h1>
	</div>
	<div id="menu">
		<ul>
            ...
            <li><a href="<?php echo base_url();?>blogger_login">Sign In</a></li>
            <li><a href="<?php echo base_url();?>blogger_login">Dashboard</a></li>
...
<div id="splash-wrapper">
	<div id="splash">
		<h2>WelCome To CodeBook</h2>
		<h2>CodeBook Is An OpenSource Blog Build On Top Of CodeIgniter The PHP Framework!!!</h2>
	</div>
</div>
<!-- end #header -->
<div id="wrapper">
